...
namespace cb {  // Computer Brain namespace
    ...
    public:
        ...
        Vector(int columns, int element_value);                                 // value constructor
        ...
        std::vector<double>& get_representation();               // I don't like this but cant find a way around it
                                                                 // ^ matrix-vector multiplication needs vector_ for parallelization
    ...
    public:
        ...
        Matrix(int rows, int columns, int element_value);
