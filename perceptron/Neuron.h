...
namespace cb {
    ...
    public:
        ...
        Neuron(int units, std::string activation, bool random_initialization=true, bool add_bias=true);
        ~Neuron() = default;
    ...
    private:
        cb::Vector layer_vector_;  // underlying representation is a cb::Vector
    };
}
